...
export default function PostCard({post}) {
  return (
    <div className="group relative w-full border border-teal-500 hover:border-2 h-[400px] overflow-hidden rounded-lg
    sm:w-[430px] transition-all">
      ...
      <div className="p-3 flex flex-col gap-2 ">
        ...
        absolute bottom-[-200px] left-0 right-0 border border-teal-500 text-teal-500 
